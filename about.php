                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="about-content">
                            ...
                            <p>We are a dedicated non-profit organization working to support social causes and create meaningful change in society. Our focus is on empowering underprivileged communities through education, healthcare, food support, and sustainable development initiatives.</p>
                            <p>With a transparent approach and community-driven efforts, we ensure that every contribution leads to real change. From providing essential resources to promoting awareness and long-term development, we strive to improve lives and create a better future for all.</p>
                        </div>
                    </div>
        ...
        <section class="dream-area pt-100 pb-70">
            <div class="container">
                <div class="section-title">
                    ...
                    <p>We work with non-profits, communities, and individuals to create meaningful social impact through education, healthcare, food support, and sustainable development initiatives.</p>
                </div>
                <div class="row">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="section-title">
                            ...
                            <p>We work closely with non-profits, social enterprises, community groups, and individuals who are dedicated to making a meaningful difference in society. Through our initiatives, we aim to build a more inclusive, supportive, and compassionate world.</p>
                        </div>
                        <div class="row">
                            <div class="col-sm-6 col-sm-6">
                                <div class="benefit-item">
                                    ...
                                    <h3>Build homes</h3>
                                    <p>We provide safe and secure housing solutions for homeless and underprivileged families. Our goal is to ensure that everyone has access to proper shelter and a dignified living environment through sustainable housing projects.</p>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6 col-sm-6">
                                <div class="benefit-item two">
                                    ...
                                    <p>We offer essential healthcare services, including free medical camps, health checkups, and medicine distribution for those in need. Our focus is on improving access to basic healthcare and promoting awareness.</p>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6 col-sm-6">
                                <div class="benefit-item three">
                                    ...
                                    <h3>Food & Water</h3>
                                    <p>We provide nutritious food and clean drinking water to fight hunger and ensure healthier communities. Our food drives and water distribution programs support people facing daily survival challenges.</p>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6 col-sm-6">
                                <div class="benefit-item four">
                                    ...
                                    <p>We support education for underprivileged children by providing learning resources, scholarships, and skill development programs. Our mission is to empower the next generation through quality education.</p>
                                </div>
                            </div>
                        </div>
                    </div>
