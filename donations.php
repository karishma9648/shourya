            ...
            <div class="row">
                <div class="col-sm-12 col-lg-6">
                    <div class="donation-item">
                        <div class="img">
                            <img src="assets/img/donation/qrcode.jpg" alt="Donation">
                        </div>
                ...
                <div class="col-sm-12 col-lg-6">
                    <div class="donation-item">
                        <div class="inner">
                            <div class="top">
                                <a class="tags" href="#">Donations</a>
                                <h3>
                                    <a href="donation-details.html">Scan to Donate</a>
                                </h3>
                                <p>Shoureya Foundation is committed to bringing quality healthcare to underprivileged
                                    communities.
                                    Your contribution helps fund medical camps, treatments, and essential health
                                    supplies for those in need.</p>
                            </div>
                            <div class="bottom">
                               

                                <div class="donation-details" style="margin-top:15px;">
                                    <strong>Bank Account Details:</strong><br>
                                    <strong>Account Name:</strong> <span>Shoureya Foundation</span><br>
                                    <strong>Account Number:</strong> <span>9876543210</span><br>
                                    <strong>Bank Name:</strong> <span>HDFC Bank</span><br>
                                    <strong>Branch:</strong> <span>Lucknow Main Branch</span><br>
                                    <strong>IFSC Code:</strong> <span>HDFC0000123</span><br>
                                </div>
                            </div>
                        </div>
